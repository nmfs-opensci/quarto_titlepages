...
cover: img/nmfs-opensci-logo.png
editor: source
format:
  pdf:
    ...
    coverpage-image-size: 1
    coverpage-image-opacity: "0.5"
    coverpage-image-fading: "north"
    coverpage-image-rotate: 0
    coverpage-image-left: "0cm"
    coverpage-image-bottom: "0cm"
    coverpage-color: "F6D5A8"
    coverpage-title-fontfamily: "Palatino Bold Italic"
    coverpage-title-fontsize: "50"
    coverpage-title-align: "left"
    coverpage-title-color: "cyan"
    coverpage-geometry: 
      - top=2in
      - bottom=0in
      - right=1in
...
![great wave](img/TheGreatWaveoffKanagawa.jpeg){#fig-wave}
