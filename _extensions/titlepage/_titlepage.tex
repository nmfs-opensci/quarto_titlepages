...
\centering\rotatebox{90}{\makebox[0.88\textheight][r]{
$if(titlepage-theme.vrule-text-fontstyle)$$for(titlepage-theme.vrule-text-fontstyle)$\$titlepage-theme.vrule-text-fontstyle$ $endfor$$endif$$if(titlepage-theme.vrule-text-color)$\color{$titlepage-theme.vrule-text-color$}$endif$ $titlepage-theme.vrule-text$}}$endif$\end{minipage}}}
$else$
