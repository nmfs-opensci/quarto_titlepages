...
**The YAML** This appears at the top of the `.qmd` file for a single qmd or `index.qmd` for a Quarto book project (multiple qmd for a book). This just shows the PDF format specification.
