...
If you don't pass in any customization, the default is the `titlepage: simple` with no images or logo (or header or footer).
...
Note `author-sep: newline` will give each author on a new line.
...
* `-colorbox-color` fill color
* `-colorbox-border-width` width of the border (in, cm, mm, pt)
* `-colorbox-border-color` border color
...
```
    titlepage-theme: 
      ...
      title-align: spread
      title-space-after: 1in
      title-colorbox-color: "cyan"
      title-colorbox-border: 2pt
      title-colorbox-border-color: "black"
      ...
      footer-colorbox-color: "cyan"
      footer-colorbox-border: 2pt
      footer-colorbox-border-color: "black"
      header-style: "plain"
      ...
      header-colorbox-color: "cyan"
      header-colorbox-border: 2pt
      header-colorbox-border-color: "black"
      date-style: "colorbox"
      ...
      date-colorbox-color: "cyan"
      date-colorbox-border: 2pt
      date-colorbox-border-color: "black"
      logo-align: center
      logo-size: 0.25
