...
Start modifying the files for a dynamic example: `examples/dynamic` or any files in `_extensions/titlepage` that does not have `-static` in the name. 

## Are you kidding me? 

**No way! I have a static title page and I want to use that.** 

Go to one of the static examples" the `static` example in the `examples` folder or the files in `_extensions/titlepage` that have `-static` in the name. 
