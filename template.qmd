...
Needs info on the titlepage geometry so the title doesn't overlap the background image. Also you need to supply the background image and where to put it (UL, upperleft; UR, upperright; BL, bottomleft; BR, bottomright).
...
This one uses the logo specified in the YAML.
...
The other themes use the YAML for the titlepage info and you do not need to edit the `...-titlepage.tex` files unless you want to customize the pages.
