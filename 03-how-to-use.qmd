...
3.  Download (or copy) the `before-body.tex`, `_titlepage.tex`, and `in-header.tex` files. *How?* Clone the repo or click on "raw" and copy and paste the code into your own file.
4.  You can download (or copy) `article.qmd` if you want an example qmd to run.
