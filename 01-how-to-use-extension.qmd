...
The extension provides a format `titlepage-pdf` where you can specify a variety of themes and customizations.
...
The all features of the text and placement of blocks (header, title, author, etc) is customizable. See the chapters on themes and customizing.
