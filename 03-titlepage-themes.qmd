...
### bg-image
<span style="font-size:0.8em; color: grey">[titlepage-theme code](03-titlepage-themes.html#bg-image-1)</span></br>![](images/bg-image.png){.border fig-alt="Screenshot of bg-image theme. Page has a background image in the top left with title, subtitle, authors and affiliations below. There is a logo towards the bottom followed by a footer."}
...
### classic-lined
<span style="font-size:0.8em; color: grey">[titlepage-theme code](03-titlepage-themes.html#classic-lined-1)</span></br>![](images/classic-lined.png){.border fig-alt="Screenshot of classic-lined theme. Page has double horizontal lines at the top and bottom. The title is in all caps, centered and at top. Authors are on one line below the title. There is a logo and footer at the bottom."}

### colorbox
<span style="font-size:0.8em; color: grey">[titlepage-theme code](03-titlepage-themes.html#colorbox-1)</span></br>![](images/colorbox.png){.border fig-alt="Screenshot of colorbox theme. Title has a cyan filled box around it. Author names are in bottom right corner."}

### formal
<span style="font-size:0.8em; color: grey">[titlepage-theme code](03-titlepage-themes.html#formal-1)</span></br>![](images/formal.png){.border fig-alt="Screenshot of formal theme. Centered text with a large title at the top. No author affiliation information."}

### plain
<span style="font-size:0.8em; color: grey">[titlepage-theme code](03-titlepage-themes.html#plain-1)</span></br>![](images/plain.png){.border fig-alt="Screenshot of plain theme. A fairly minimal title page with no styling."}
