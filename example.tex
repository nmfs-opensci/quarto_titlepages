...
{Hugetextbf\nohyphens{The title}}\\[1\baselineskip]

{LARGE{See the documentation for available formats.}}\\}
...
\fcolorbox{black}{cyan}{
	\parbox[t]{0.93\minipagewidth}{ % Outer full width box
		\parbox[t]{0.91\minipagewidth}{ % Inner box for inner right text margin
			...
			{LARGE\nohyphens{See the documentation for available formats.}}\\
...
% Title and subtitle
{Hugetextbf\nohyphens{The title}}\\[1\baselineskip]
{{See the documentation for available formats.}}\\
...
\ifthenelse{\equal{plain-newline}{none}}
{% True case
...
\ifthenelse{\equal{plain-newline}{plain}}
{% True case
...
\ifthenelse{\equal{plain-newline}{plain-newline}}
{% True case
...
\ifthenelse{\equal{plain-newline}{plain-with-and}}
{% True case
...
\ifthenelse{\equal{plain-newline}{plain-superscript}}
{% True case
\newcommand{\titlepageauthorblock}{\plainsuperscriptauthorblock}
}{}
\ifthenelse{\equal{plain-newline}{superscript}}
{% True case
\newcommand{\titlepageauthorblock}{\superscriptauthorblock}
}{}
\ifthenelse{\equal{plain-newline}{superscript-with-and}}
{% True case
\newcommand{\titlepageauthorblock}{\superscriptwithandauthorblock}
}{}
\ifthenelse{\equal{plain-newline}{two-column}}
{% True case
...
\ifthenelse{\equal{}{numbered-list}}
{% True case
\newcommand{\titlepageaffiliationblock}{\numberedlistaffiliationblock}
}{}
\ifthenelse{\equal{}{numbered-list-with-correspondence}}
{% True case
\newcommand{\titlepageaffiliationblock}{\numberedlistwithcorraffiliationblock}
}{}
...
\ifthenelse{\equal{}{right} \OR \equal{}{leftright} }%
{% True case
\hspace{\B}
\rule{\A}{\textheight}
}{}
