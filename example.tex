...
\includegraphics[width=\paperwidth, keepaspectratio]{\_extensions/titlepage/images/otter-bar.jpeg}};
...
\node[anchor=north
west, align=left, rotate=0] (Title1) at ($(current page.south west)+(\titlelocationleft,\titlelocationbottom)$)  [text width = 0.7000000000000001\paperwidth]  {
\textcolor{white}{Otters}};
}
\end{scope}
...
($(current page.south west)+(\footerlocationleft,\footerlocationbottom)$)  [text width = 0.7000000000000001\paperwidth]  {
{Dec 2025}};
...
\ifthenelse{\equal{right}{right}}{\raggedleft}{}
\ifthenelse{\equal{right}{center}}{\centering}{}
\ifthenelse{\equal{right}{left}}{\raggedright}{}
\ifthenelse{\equal{right}{spread}}{\makebox[\linewidth][s]}{}
}
...
{\nohyphens{A Sample Title - The SocioEconomic Aspects of Stock
Assessments}}\par
}%
...
\authorstyle{Jane Doe\\Eva Nováková\\Matti Meikäläinen\\Ashok Kumar\par}
}
...
\setlength{\betweentitlesubtitle}{5\baselineskip}
{
...
\newcommand{\authorblock}{{\titlepageauthoralign
\titlepageauthorblock}
...
\authorblock
\par
\end{minipage}\ifthenelse{\equal{leftright}{right} \OR \equal{leftright}{leftright} }{
\hspace{\B}
\vrulecode}{}
\clearpage
%%% TITLE PAGE END
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, frame hidden, sharp corners, breakable]}{\end{tcolorbox}}\fi
