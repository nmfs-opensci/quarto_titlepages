...
\begin{scope}
{%
\fontsize{100}{120.0}\selectfont
\coverpagetitlefont
\node[anchor=north
west, align=left, rotate=0] (Title1) at ($(current page.south west)+(\titlelocationleft,\titlelocationbottom)$)  [text width = 0.7\paperwidth]  {\textcolor{white}{\nohyphens{Otters}}};
}
\end{scope}

% Author
\newcommand{\authorlocationleft}{0.8\paperwidth}
\newcommand{\authorlocationbottom}{2in}
...
\node[anchor=north
east, align=right, rotate=0] (Author1) at ($(current page.south west)+(\authorlocationleft,\authorlocationbottom)$)  [text width = 0.7\paperwidth]  {
\coverauthorstyle{EE\\Holmes\\}};
}
\end{scope}
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, frame hidden, sharp corners, enhanced, borderline west={3pt}{0pt}{shadecolor}, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
