...
\begin{scope}
{%
\fontsize{30}{36.0} \coverpagetitlefont
\node[anchor=north
...
\begin{scope}
{%
\fontsize{20}{24.0} \coverpagefooterfont
...
{Templates for title pages and covers}};
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, sharp corners, breakable, enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
