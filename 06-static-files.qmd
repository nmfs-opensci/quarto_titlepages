...
You can include these as raw tex files. They appear after the title page. The quarto_titlepages repository has examples of these pages in the `tex` folder. You can include as many raw tex files for your frontmatter as you need.
