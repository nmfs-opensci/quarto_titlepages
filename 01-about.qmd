...
If you use authblk in your titlepage, you will need to write your `\author` and `affil` definitions in `title.tex` and then you can use those in `before-body.tex` in your `\begin{titlepage}...\end{titlepage}` code.

## More notes

See the [notes chapter](@sec-notes) for some notes I took along the way.
